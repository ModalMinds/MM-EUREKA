...
class NaiveExperienceMaker(ABC):
    ...
    def make_experience_list(
        ...
        # calculate return and advantages
        for experience1 in experiences1:
            # experience1 = experience1.to_device("cuda")
            experience1.info["return"] = experiences[0].info["return"]
            # experience1.advantages = deepcopy(experience1.returns)
            
            experience1.kl = None
            # print(experience1.info.keys())
            # print('experience1.info.keys()')
            if 'num_actions' in experience1.info.keys():
                del experience1.info["num_actions"]
            experience1.to_device("cpu")
            
            
        return experiences, experiences1
...
class RemoteExperienceMaker(NaiveExperienceMaker):
    ...
    def make_experience_list(
        ...
        experiences, experiences1 = super().make_experience_list(all_prompts, all_labels, global_step, **generate_kwargs)
    ...
    def make_experience(self, samples: Samples) -> Experience:
        ...
        if not self.remote_rm_url:
            ...
            if self.custom_reward_func:
                ...
                # print('samples.labels: ', samples.labels)
